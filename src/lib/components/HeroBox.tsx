...
import { HeroBoxImage } from "./HeroBoxImage"
  ...
  return (
    <div className="flex flex-col w-full max-w-2xl items-center gap-4">
      <form
        ...
        className="bg-orange-light w-full flex flex-col md:flex-row-reverse gap-6 text-purple p-6 rounded-lg"
      >
        <HeroBoxImage />
        <div className="flex flex-col flex-1">
          ...
          <Button disabled={props.searchLoading} size="lg" className="mt-3">
            {props.searchLoading ? (
              <>
                {loadingTexts[loadingTextIndex]}
                <LoaderIcon className="size-5 ml-1 text-indigo animate-spin" />
              </>
            ) : (
              "Search"
            )}
